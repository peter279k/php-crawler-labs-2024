...
$cookieJar = CookieJar::fromArray([
    ...
    'ASP.NET_SessionId' => '0tkrkvxiqmfpl0cl143x4f5s',
], 'ezpost.post.gov.tw');
...
$responseJson = json_decode($responseJson['d'], true);
...
$printPdfUrl = 'https://ezpost.post.gov.tw/PrintPdf.aspx';
$response = $client->request('POST', $printPdfUrl, [
    'headers' => $header,
    'json' => $payload,
    'cookies' => $cookieJar,
